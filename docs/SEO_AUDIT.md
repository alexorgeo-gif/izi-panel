...
| `sitemap.xml` | `[FACT]` production → HTTP 200, но `text/html` и тело 404 | P0 | XML sitemap только с `https://izipanel.ru/` | Staging → 200 `application/xml`; live ожидает активации |
